      ...
      <div className="container pt-24 md:pt-36 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div className="flex flex-col w-full xl:w-2/5 justify-center lg:items-start overflow-y-hidden">
          ...
          <form className="bg-gray-900 opacity-75 w-full shadow-lg rounded-lg px-8 pt-6 pb-8 mb-4">
            <div className="mb-4">
              <label className="block text-gray-500 py-2 font-bold mb-2" htmlFor="emailaddress">
                Newsletter
              </label>
              <input
        ...
        {/* Right Col */}
                  <div className="w-full xl:w-3/5 p-12 overflow-hidden flex justify-center">
                      <p>
            Espaço na direita para conteúdo
        ...
        <div className="mx-auto md:pt-16">
          ...
          <a rel="norereferrer" className="inline-block text-gray-500 no-underline hover:text-red-400 hover:text-underline text-center h-10 p-2 md:h-auto md:p-4 transform hover:scale-125 duration-300 ease-in-out" href="https://twitter.com/intent/tweet?url=#">
        ...
        <div className="w-full pt-16 pb-6 text-sm text-center md:text-left fade-in">
          <a rel="norereferrer" className="text-gray-500 no-underline hover:no-underline mr-1" href="#">&copy; Nome do cliente</a>
          - Criado por
          <a rel="norereferrer" className="text-gray-500 no-underline hover:no-underline ml-1" href="https://www.xgrow.com">XGrow</a>
        </div>
      </div>
      </>
  )
