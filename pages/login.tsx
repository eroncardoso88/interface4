            ...
            <div className="flex flex-col w-full xl:w-1/4 justify-center lg:items-start overflow-y-hidden">
                ...
                <form className="bg-gray-900 opacity-75 w-full shadow-lg rounded-lg px-8 pt-6 pb-8 mb-4">
                  <div className="mb-4">
                    <div className="css-4302v8">
                      <p className="opacity-0 flex flex-row justify-center pt-5 font-bold text-white text-2xl mb-8">
                  ...
                  <div className="mb-4">
                    <div className="css-a0kk5w">
                      ...
                      <div>
                        ...
                        >
                          <svg onClick={() => setPasswordShow(!passwordShow)}
                            stroke="currentColor"
                            fill="currentColor"
                            strokeWidth="0"
                            viewBox="0 0 24 24"
                      ...
                      <div>
                        ...
                        >
                          <svg onClick={() => setPasswordShow(!passwordShow)}
                          stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" focusable="false" className="cursor-pointer css-11p1vtb" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M12 4.5C7 4.5 2.73 7.61 1 12c1.73 4.39 6 7.5 11 7.5s9.27-3.11 11-7.5c-1.73-4.39-6-7.5-11-7.5zM12 17c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5zm0-8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z"></path></svg>
                        </div>
                      </div>
                      )}
                    </div>
                  ...
                  <div className="flex flex-row justify-between">
                    <div className="flex align-center">
                      ...
                      />
                      <label htmlFor="remember" className="pl-2 text-white">
                        Lembrar-me
                      </label>
                    </div>
                    <div>
                  ...
                  <p className="flex flex-row justify-center pt-5 text-white">
                    ...
                    <a
                      ...
                      className="pl-2 font-bold text-red-500"
                    >
                      Fale com o suporte
                    </a>
                  </p>
              ...
              {passwordRecovery && (
                <form className="bg-gray-900 opacity-75 w-full shadow-lg rounded-lg px-8 pt-6 pb-8 mb-4 h-5/6">
                  <p className="flex flex-row justify-center pt-5 font-bold text-white text-2xl mb-8">
                    Recuperação de Senha
                  </p>
                  <p className="flex flex-row justify-center font-bold text-white text-base text-center mb-10">
                  ...
                  <p className="flex flex-row justify-center pt-5 text-white">
                    <p
                      ...
                      className="pl-2 font-bold text-red-500 cursor-pointer"
                    >
                      Voltar para Login
                    </p>
                  </p>
